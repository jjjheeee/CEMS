...
<!-- Main content START -->
			<div class="col-xl-12 container">
				<!-- Edit profile START -->
				<div class="col-lg-12 mx-auto pe-3">
				<div class="card bg-transparent border rounded-3">
					...
					<!-- Card body START -->
						...
						<div class="card-body">
							<!-- Form -->
							<form action="/CEMS/update/updateall" target="_parent" method="post" class="row g-4">
								...
								<div class="col-md-6">
									...
									<input class="form-control" type="text" value="<c:out value='${user.user_id}'/>"  placeholder="Email" disabled>
									<input class="form-control" type="text" name="user_id" value="<c:out value='${user.user_id}'/>"  placeholder="Email" style="display: none;">
								</div>
								...
								<div class="col-6">
									...
									<div class="input-group">
										<input type="text" class="form-control" name="user_name" value="<c:out value='${user.user_name}'/>" placeholder="이름" disabled>
									</div>
								</div>
								...
								<div class="col-md-6">
									...
									<div class="input-group">
										<input type="text" oninput="nickCheck();" class="form-control" id="user_nickname" name="user_nickname" value="<c:out value='${user.user_nickname}'/>"/>
									</div>
									<div id="nickcheckdiv" style="display: none;" class="m-1"><h6 style="color: red; opacity: 70%;"></h6></div>
								</div>
								
								<!-- Location -->
								<div class="col-md-6">
									<label class="form-label">국적</label>
									<input class="form-control" type="text" name="user_country" value="<c:out value='${user.user_country}'/>" disabled>
								</div>
								...
								<div class="d-sm-flex justify-content-end">
									<button type="submit" id="submit1"class="btn btn-primary mb-0" disabled>변경</button>
								</div>
							</form>
						</div>
					</div>
