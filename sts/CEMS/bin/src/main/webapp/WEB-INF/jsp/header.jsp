...
// Login Check.
var login_C = '<c:out value="${user.user_id}"/>';
				...
				<ul class="navbar-nav navbar-nav-scroll">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="demoMenu">
							...
							<li> <hr class="dropdown-divider"></li>
							<li> <a class="dropdown-item topik" href="#">단어장 <i class="bi bi-box-arrow-up-right fa-fw me-1"></i></a> </li>
						</ul>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="demoMenu">
							...
							<li> <a class="dropdown-item" href="admin"><i class="bi bi-telephone-fill fa-fw me-1"></i> ADMIN Dashboard</a></li>
