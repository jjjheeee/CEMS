...
<html lang="en">
<head>
<title>CEMS-Topik : TOPIK I</title>
...
<!-- =======================
Page Banner START -->
<section class="bg-light position-relative" style="height: 400px;">
			...
			<div class="col-12">
				<div class="row align-items-center">
					...
					<div class="col-6 col-md-3 text-center order-1">
						<img src="/CEMS/assets/images/element/category-1.svg" alt="">
					</div>
					...
					<div class="col-md-6 px-md-5 text-center position-relative order-md-2 mb-5 mb-md-0">
						...
						<!-- Title -->
						<h2 class="mb-3">무엇을 배우고 싶으신가요?</h2>
						<p class="mb-3">CEMS-Topik과 함께 실력을 향상시켜보아요!</p>
					...
					<div class="col-6 col-md-3 text-center order-3">
						<img src="/CEMS/assets/images/element/category-2.svg" alt="">
					</div>
		...
		<div class="row g-4 justify-content-center">
			...
			<div class="col-sm-4 col-md-4 col-xl-4">
				<div class="card card-body bg-success bg-opacity-10 text-center position-relative btn-transition p-4">
					<!-- Image -->
					<div class="w-50 h-100 bg-body mx-auto rounded-circle mb-3">
						<img src="/CEMS/assets/images/element/add-course.svg" alt="">
					</div>
					<!-- Title -->
					<h5 class="mb-2"><a href="/CEMS/듣기" class="stretched-link">듣기</a></h5>
				</div>
			</div>
			<!-- Item : 읽기 -->
			<div class="col-sm-4 col-md-4 col-xl-4">
				<div class="card card-body bg-success bg-opacity-10 text-center position-relative btn-transition p-4">
					...
					<!-- Title -->
					<h5 class="mb-2"><a href="/CEMS/연습문제" class="stretched-link">읽기</a></h5>
				</div>
			</div>
