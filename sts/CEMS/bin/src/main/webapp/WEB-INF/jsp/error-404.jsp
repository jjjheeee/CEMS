...
<!-- 				<img class="dark-mode-item navbar-brand-item" src="/CEMS/assets/images/logo-light.svg" alt="logo"> -->
<!-- 			</a> -->
<!-- 			<!-- Logo END -->
...
<!-- 								<img class="avatar-img rounded-circle shadow" src="/CEMS/assets/images/avatar/01.jpg" alt="avatar"> -->
<!-- 							</div> -->
<!-- 							<div> -->
	...
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<!-- Image -->
				<img src="/CEMS/assets/images/element/error404-01.svg" class="h-200px h-md-400px mb-4" alt="">
				<!-- Title -->
				...
				<!-- Button -->
				<a href="/CEMS/home" class="btn btn-primary mb-0">Take me to Homepage</a>
			</div>
		</div>
	</div>
</section>
