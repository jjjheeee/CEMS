...
<section class="bg-light py-0 py-sm-5">
	<div class="container">
		<div class="row">
			<div class="col-lg-8">
				<!-- Badge -->
				<h5 class="mb-4 font-base bg-primary text-white py-2 px-4 rounded-2 d-inline-block">TOPIK 2 - 쓰기</h5>
				<!-- Title -->
				<!-- <h2>빈칸 채우기</h2> -->
				<!-- <p>test</p> -->
				<!-- Content -->
...
<!-- 
	...
	<button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill" data-bs-target="#course-pills-1" type="button" role="tab" aria-controls="course-pills-1" aria-selected="true">Q</button>
						...
						<div class="tab-content " id="course-pills-tabContent">
							<!-- Content START -->
									<div class="active_button col-10 mx-auto tab-pane fade" id="course-pills-${status.count}" role="tabpanel" aria-labelledby="course-pills-tab-${status.count}">
										...
										<script>
											$('#textBox').keyup(function (e) {
												...
												if (content.length > 700) {
													// 700자 부터는 타이핑 되지 않도록 설정한다 
													$(this).val($(this).val().substring(0, 700));
													// 700자 넘으면 알림창 뜨도록 설정한다 
										...
										<!-- List content -->
										<div class="my-5" > 
											<h5 class="mt-5 my-1">쓰기</h5>
											<!-- 쓰기 text area 추가 -->
											<div class="col-12" >
												<div class="textLengthWrap text-end">
													<span class="textCount">0자</>
													<span class="textTotal">/700자</span>
												</div>
												<div class="col-12">
													<textarea style="height:300px; resize: none; width: 100%;" maxlength="700" placeholder="텍스트를 입력하세요." id="textBox"></textarea>
												</div>
											</div>
										</div>
											<!-- Fake input -->
