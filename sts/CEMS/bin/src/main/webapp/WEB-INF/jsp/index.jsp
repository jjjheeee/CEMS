...
<section class="position-relative overflow-hidden pt-5 pt-lg-3">
	...
	<div class="container">
		<!-- Title -->
		<div class="row align-iclass="d-sm-flex align-items-center justify-content-center justify-content-lg-start"tems-center g-5">
			<!-- Left content START -->
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<!-- Title -->
				<h1 class="mb-0 display-6 py-5">"C.E.M.S - Topik,<br>
					<span class="position-relative">1등엔 이유가 있습니다." 
						<!-- SVG START -->
						<span class="position-absolute top-50 start-50 translate-middle ms-3 z-index-n1">
							<svg width="300px" height="70px" enable-background="new 0 0 366 70" viewBox="0 0 366 70 " xmlns="http://www.w3.org/2000/svg">
				...
				<!-- Content -->
				<p class="my-4 lead" style="visibility: hidden;">토픽토픽토픽토픽 </p>
				

				<!-- Info -->
				<ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
					<li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>점수가 오를만한 문제만</li>
					<li class="list-inline-item me-2"> <i class="bi bi-patch-exclamation-fill h6 me-1"></i>매일 눈에 보이는 점수상승</li>
					<li class="list-inline-item"> <i class="bi bi-patch-question-fill h6 me-1"></i>틀린 문제는 자동 복습</li>
				</ul>
				...
				<!-- 토픽 시험장 검색-->
				<div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
					<form class="border rounded p-2 mb-4 w-75" action="find_place" method="post">
						<div class="input-group">
							<input class="form-control border-0 me-1 " type="search" placeholder="Topik 일정 검색">
				...
				<section class="pt-0" style="display: none;">
					<div class="container" style="display: inline;">
						<div class="row">
							<div class="col-12">
								<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3165.5692519766944!2d127.0278719512159!3d37.494490035908846!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca158ea750d33%3A0xf29e40ea72daaa48!2z642U7KGw7J2A7Lu07ZOo7YSw7JWE7Lm0642w66-47ZWZ7JuQIOqwleuCqOygkA!5e0!3m2!1sko!2skr!4v1668497031582!5m2!1sko!2skr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
							</div>
						</div>
					</div>
				</section>
			...
			<!-- Right content START -->
			<div class="col-lg-7 col-xl-6 my-auto text-center">
				<div>
					<h5>😍 여러분들의 학습률을 비교해 보세요 ! 🙌 </h5>
				</div>
			...
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3">
					...
					<div class="ms-4 h6 fw-normal mb-0">
						...
						<p class="mb-0"></p> <!-- Online Students -->
					</div>
				</div>
			</div>
			<!-- Counter item -->
			<div class="col-sm-6 col-xl-3">
				<div class="d-flex justify-content-center align-items-center p-4 bg-info bg-opacity-10 rounded-3">
					...
					<div class="ms-4 h6 fw-normal mb-0">
						...
						<p class="mb-0"></p>	<!-- Certified Courses -->
					</div>
				</div>
			</div>
		</div>
...
<script>
	var marksCanvas2 = document.getElementById("lineChart");
	...
	datasets: [{
		label: '내가 푼 문제',
		data: [
		<c:forEach items="${cntlist}" var="c" varStatus="status">
				'${c.user_cnt}',
		</c:forEach>
		],
		fill: false,
...
<script src="/CEMS/assets/vendor/glightbox/js/glightbox.js"></script>
