		...
		<div class="card-header bg-light">
			...
			<div class="row g-3 align-items-center justify-content-between mx-5">
				...
				<div class="col-1 mt-4 ps-4">
					<h6><a href="/CEMS/board_write0">글쓰기</a></h6>
				</div>
			</div>
		...
		<div class="card-body col-10 mx-auto">
			...
			<div class="table-responsive border-0 rounded-3">
				...
				<table class="table table-dark-gray align-middle p-4 mb-0 table-hover table-bordered">
					...
					<tbody>
						<!-- 북마크 게시물 시작-->
						<c:forEach items="${mark_boardlist}" var="mark_board" varStatus="status">
						<tr class="table-warning">
							<td>
								<div class="d-flex align-items-center position-relative">
									<h6 class="table-responsive-title mb-0 mx-auto">	
										<span>공지</span>
									</h6>
								</div>
							</td>
							...
							<td>
								<div class="d-flex align-items-center">
									<div class="ms-2">
										<a href="/CEMS/board_${mark_board.board_id}" class="mb-0 fw-light">${mark_board.title}</a>
									</div>
								</div>
							</td>

							<td class="text-center">
								<strong>${mark_board.writer}</strong>
							</td>

							<td class="text-center">
								${mark_board.write_date}
							</td>
						...
						<!-- 유저 게시물 시작 -->
						<c:forEach items="${user_boardlist}" var="user_board" varStatus="status">
						<tr>
							<td>
								<div class="d-flex align-items-center position-relative">
									<h6 class="table-responsive-title mb-0 mx-auto">	
							...
							<td>
								<div class="d-flex align-items-center">
									<div class="ms-2">
										<a href="/CEMS/board_${user_board.board_id}" class="mb-0 fw-light">${user_board.title}</a>
									</div>
								</div>
							</td>

							<td class="text-center">
								<strong>${user_board.writer}</strong>
							</td>

							<td class="text-center">
								${user_board.write_date}
							</td>
