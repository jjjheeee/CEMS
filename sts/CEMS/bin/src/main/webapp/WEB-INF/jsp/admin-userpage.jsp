	...
	<div class="offcanvas offcanvas-start flex-row custFom-scrollbar h-100" data-bs-backdrop="true" tabindex="-1" id="offcanvasSidebar">
		<div class="offcanvas-body sidebar-content d-flex flex-column bg-dark">
			...
			<ul class="navbar-nav flex-column" id="navbar-sidebar">
				...
				<!-- Menu item 1 -->
				<li class="nav-item"><a href="/CEMS/admin" class="nav-link"><i class="bi bi-house fa-fw me-2"></i>Dashboard</a></li>
				
				<!-- Title -->
				<li class="nav-item ms-2 my-2">Pages</li>

				<!-- Menu item 3 -->
				<li class="nav-item"> <a class="nav-link active" href="/CEMS/admin/admin-userpage"><i class="fas fa-user-graduate fa-fw me-2"></i>Students</a></li>
							...
							<!-- Table row -->
								...
								<tr class="text-center">
									...
									<td>
										...
										<button type="button" onclick="ban_toggle(this.id);" id="B_ban_btn_${status.index}" class="btn border me-1 mb-0" data-bs-toggle="button">B</button>
										<button type="button" onclick="ban_toggle(this.id);" id="C_ban_btn_${status.index}" class="btn border me-1 mb-0" data-bs-toggle="button">C</button>
										...
										<button type="button" onclick="ban_toggle(this.id);" id="A_ban_btn_${status.index}" class="btn border me-1 mb-0" data-bs-toggle="button">A</button>

										<button type="button" onclick="ban_toggle(this.id);" id="0_ban_btn_${status.index}" class="btn btn-success me-1 mb-0" data-bs-toggle="button">X</button>
